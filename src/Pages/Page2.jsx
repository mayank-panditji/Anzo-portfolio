...
const Page2 = () => {
    ...
    <div id="section2" className="bg-white text-center text-black p-20">
      ...
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4]  leading-[35vw]  ">IMPACTFUL</h1>
      </div>
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4]  leading-[35vw] ">DESIGN</h1>
      </div>
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4] leading-[35vw] ">IS THE</h1>
      </div>
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4]  leading-[35vw] ">DESIGN</h1>
      </div>
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4] leading-[35vw] ">THAT</h1>
      </div>
      <div className="rotatetext">
        <h1 className="text-[42vw] text-black font-[anzo4] leading-[35vw] ">WORKS</h1>
      </div>
