...
const Page4 = () => {
  ...
  return (
    <div className='h-screen p-4 bg-white relative'>
      ...
      <div
        className='h-full w-full bg-cover bg-center rounded-[100px]'
        style={{ backgroundImage: "url('/BackgroundAnzoStudio.avif')" }}
      ></div>

     
      <h1 className='font-[anzo4] text-[20vw] absolute text-[#9B9B9B] uppercase bottom-60 left-36'>what</h1>
      <h1 className='font-[anzo4] text-[20vw] absolute text-white uppercase bottom-4 left-40'>I DO</h1>
